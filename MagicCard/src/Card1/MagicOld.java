...
/**********************INCLUDES COMMENTS AND OLD CODE***************/
...
//	
//	//deck = new String[52]; //empties array
//	//String spade = "♠"; String diamond = "♦"; String clover = "♣"; String heart = "♥"; //when i tried using char it gave null
//	//String addsuit = "\0";
...
//			//System.out.println(addsuit);
//			//System.out.println(Character.toString(addsuit)+x[i]);
//			deck[counterdeck++] = Character.toString(addsuit)+x[i]; //adds the suit to the string and then adds it to the actual deck
//			
//		}
//		countersuit++;
//	}
...
//	
////	while (changecol <3) {
////		if(changecol == 0) {ArrayList<String> temp1 = col1;} 
////		else if (changecol == 1) { ArrayList<String> temp1 = col2; }
////		else if (changecol == 2) { ArrayList<String> temp1 = col3; }
////		
////		for(int i = 0; i < 7; i++) {
////			temp1.add
////		}
